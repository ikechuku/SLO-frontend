    ...
    render() {
        return (
            ...
            <div className="chatHead">
                <span style={{fontWeight:' 600'}} className="senderIcon">David Joe</span>

                <span className="sendertoggle"><img src={addChatMate} alt=""/></span>
            </div>
<div className="position-breaker"></div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Isse culpa!</p>
            </div>
            </div>
